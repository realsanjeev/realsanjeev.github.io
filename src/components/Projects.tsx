      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-8">
          {MAJOR_PROJECTS.map((project, index) => (
            <div key={index} className={`border-l-4 ${getProjectColor(project.type)} pl-8 pb-8`}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {GITHUB_PROJECTS.map((project, idx) => (
                <li key={idx} className="border rounded-lg p-6 flex flex-col md:flex-row md:items-center justify-between bg-gray-50">
                  <div>
